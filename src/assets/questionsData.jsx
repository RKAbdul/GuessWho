const questionsData = [
    ...
    },
    {
      ...
      {
        category: "Numeric Questions",
        questions: [
          ["In how many minutes do you run 1 km?", "0-50"],
          ["How many hours do you sleep on average per night?", "0-12"],
          ["How many times do you shower per week?", "0-10"],
          ["How many books have you read in the last year?", "0-30"],
          ["How many kilometers can you walk without stopping?", "0-15"],
          ["How many push-ups can you do in one go?", "0-80"],
          ["How many hours a week do you exercise?", "0-20"],
          ["How many different countries have you visited?", "0-25"],
          ["How many cups of water do you drink daily?", "0-12"],
          ["How many minutes does it take you to get ready in the morning?", "0-90"],
          ["How many languages can you speak conversationally?", "0-6"],
          ["How many hours a day do you spend on your phone?", "0-10"],
          ["How many close friends do you have?", "0-25"],
          ["How many pull-ups can you do consecutively?", "0-40"],
          ["How many concerts have you been to in your life?", "0-50"],
          ["How many kilometers do you walk per day on average?", "0-15"],
          ["How many times do you go to the gym per week?", "0-10"],
          ["How many hours can you work without a break?", "0-12"],
          ["How many sit-ups can you do without stopping?", "0-100"],
          ["How many minutes do you spend cooking dinner on average?", "0-90"],
          ["How many different musical instruments can you play?", "0-8"],
          ["How many hours a week do you study or read for personal development?", "0-30"],
          ["How many times do you eat out per week?", "0-15"],
          ["How many movies do you watch per month?", "0-20"],
          ["How many years have you been driving?", "0-40"],
          ["How many minutes can you hold your breath underwater?", "0-10"],
          ["How many times do you travel per year?", "0-20"],
          ["How many hours a day do you spend outdoors?", "0-12"],
          ["How many squats can you do in one set?", "0-100"],
          ["How many hours of TV do you watch per week?", "0-40"],
          ["How many times do you check social media per day?", "0-100"],
          ["How many stairs can you climb without getting winded?", "0-200"],
          ["How many photos do you take per week on average?", "0-150"],
          ["How many hours a week do you spend on hobbies?", "0-30"],
          ["How many kilometers can you cycle without stopping?", "0-80"],
          ["How many times do you cook at home per week?", "0-20"],
          ["How many hours of music do you listen to daily?", "0-12"],
          ["How many burpees can you do consecutively?", "0-60"],
          ["How many times do you wash your car per month?", "0-12"],
          ["How many minutes do you meditate or practice mindfulness daily?", "0-90"],
          ["How many different sports have you played competitively?", "0-10"],
          ["How many hours a week do you volunteer or help others?", "0-30"],
          ["How many times do you go swimming per month?", "0-20"],
          ["How many minutes does your commute take one way?", "0-120"],
          ["How many minutes can you hold a plank?", "0-15"],
          ["How many times do you clean your house per week?", "0-10"],
          ["How many podcasts do you listen to per week?", "0-25"],
          ["How many kilometers do you run per week?", "0-60"],
          ["How many times do you visit your family per month?", "0-15"],
          ["How many hours a night do you spend gaming?", "0-10"],
          ["How many cups of coffee do you drink per day?", "0-10"],
          ["How many times do you go hiking per year?", "0-50"],
          ["How many minutes do you spend stretching daily?", "0-60"],
          ["How many different cities have you lived in?", "0-15"],
          ["How many hours can you go without checking your phone?", "0-24"],
          ["How many times do you try a new restaurant per month?", "0-15"],
          ["How many jumping jacks can you do in a row?", "0-200"],
          ["How many hours a week do you spend cleaning?", "0-20"],
          ["How many times do you brush your teeth per day?", "0-5"],
          ["How many hours of sleep do you need to feel rested?", "0-12"],
          ["How many times do you go to the movies per year?", "0-50"],
          ["How many hours a week do you spend with friends?", "0-40"],
          ["How many times do you do laundry per week?", "0-10"],
          ["How many minutes can you jog without stopping?", "0-120"],
          ["How many times do you grocery shop per week?", "0-10"],
          ["How many hours a day do you spend working?", "0-16"],
          ["How many times have you changed jobs in your career?", "0-20"],
          ["How many kilometers can you swim without stopping?", "0-10"],
          ["How many times do you call your parents per week?", "0-15"],
          ["How many hours a week do you spend on social media?", "0-60"],
          ["How many times do you go out with friends per month?", "0-30"],
          ["How many minutes does it take you to fall asleep?", "0-90"],
          ["How many different jobs have you had in your life?", "0-25"],
          ["How many hours a week do you spend cooking?", "0-30"],
          ["How many times do you order takeout per week?", "0-15"],
          ["How many different apps do you use daily?", "0-50"],
          ["How many hours can you study without getting distracted?", "0-10"],
          ["How many times do you snack per day?", "0-15"],
          ["How many mountain climbs or big hikes have you completed?", "0-30"],
          ["How many hours a week do you spend in meetings?", "0-40"],
          ["How many times do you go to a café per week?", "0-15"],
          ["How many different skills or crafts can you do well?", "0-20"],
          ["How many hours a week do you spend learning something new?", "0-30"],
          ["How many times have you moved houses in your life?", "0-20"],
          ["How many minutes do you spend on skincare daily?", "0-45"],
          ["How many different types of cuisine can you cook?", "0-15"],
          ["How many hours a week do you spend commuting?", "0-30"],
          ["How many times do you get a haircut per year?", "0-20"],
          ["How many different pets have you owned in your life?", "0-15"],
          ["How many hours a week do you spend on creative activities?", "0-40"],
          ["How many times do you visit the doctor per year?", "0-30"],
          ["How many different hobbies do you actively pursue?", "0-12"],
          ["How many hours can you dance continuously?", "0-8"],
          ["How many times do you treat yourself to something special per month?", "0-20"],
          ["How many kilometers is your usual bike ride?", "0-50"],
          ["How many hours a week do you spend relaxing or doing nothing?", "0-40"],
          ["How many times have you been on a plane in the last year?", "0-40"],
          ["How many different careers or fields have you worked in?", "0-10"],
          ["How many new people do you meet per month on average?", "0-50"],
          ["How many times do you go to parties per year?", "0-40"],
          ["How many words per minute can you type?", "0-150"],
        ]
      }
  ];
